            ...
            <div className="tweakCard">
                <div className="tweakInfo">
                    ...
                    <Text className="tweakAuthor" size="size16-1P40sf">
                        <span>Created by <Anchor href={this.props.authorUrl}>{this.props.author}</Anchor></span>
                    </Text>
